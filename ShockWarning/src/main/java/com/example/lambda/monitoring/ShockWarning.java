...
public class ShockWarning implements RequestHandler<Object, String> {
	...
	public String handleRequest(Object input, Context context) {
	    ...
	    final String msg = "*외부에서 충격이 감지되었습니다.*\n";
	    final String subject = "충격이 감지되었습니다";
	    if (shock2 <= 1000.0) {
